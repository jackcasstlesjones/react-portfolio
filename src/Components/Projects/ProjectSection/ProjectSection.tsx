...
export default function ProjectSection({ project }: ProjectSectionProps) {
  return (
    ...
    >
      ...
      <div className="max-w-xs sm:max-w-xl mx-auto grid grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10 sm:max-w-sm md:w-full">
